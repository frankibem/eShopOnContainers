...
namespace eShopOnContainers.Helpers
{
    public static class ServicesHelper
    {
        ...
        public static void FixCatalogItemPictureUrl(IEnumerable<CatalogItem> catalogItems)
        {
            ...
            try
            {
                if (!ViewModelLocator.UseMockService && Settings.UrlBase != GlobalSetting.DefaultEndpoint)
                {
